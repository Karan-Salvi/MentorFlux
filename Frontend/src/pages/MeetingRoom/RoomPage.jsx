          ...
          <div className="rounded-sm overflow-hidden relative h-[58vh]">
            ...
            <div className="flex absolute bottom-1 justify-center w-full">
              <div className="flex justify-between">
                <button
                  type="button"
                  class="focus:outline-none text-white bg-gray-800 hover:bg-black focus:ring-4 focus:ring-gray-400 font-medium rounded-lg text-sm p-2.5  dark:bg-gray-700 dark:hover:bg-gray-900 dark:focus:ring-gray-700 m-6 flex justify-center items-center"
                ...
                <button
                  type="button"
                  class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm p-2.5  dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 m-6 flex justify-center items-center"
